...
resource "linode_domain_record" "stg_oldeworld_cltger_config_records__vlan" {
  count = local.cltger_node_count
...
resource "linode_domain_record" "stg_oldeworld_cltger_config_records__public" {
  count = local.cltger_node_count
...
resource "linode_domain_record" "stg_oldeworld_cltger_config_records__private" {
  count = local.cltger_node_count
