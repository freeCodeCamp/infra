...
resource "linode_domain_record" "stg_oldeworld_cltjpn_dnsrecord__vlan" {
  count = local.cltjpn_node_count
...
resource "linode_domain_record" "stg_oldeworld_cltjpn_dnsrecord__public" {
  count = local.cltjpn_node_count
...
resource "linode_domain_record" "stg_oldeworld_cltjpn_dnsrecord__private" {
  count = local.cltjpn_node_count
