...
locals {
  ...
  clt_config_meta = {
    ...
    kor = { name = "kor", ipam_id = 50, node_count = local.clt_node_count }  # 10.0.0.90, 10.0.0.91, ...
    ara = { name = "ara", ipam_id = 55, node_count = local.clt_node_count }  # 10.0.0.95, 10.0.0.96, ...
    # Full. 10.0.0.97-99 remain; ipam_id 60 would reach .100, which is ipam_block_nws.
  }
