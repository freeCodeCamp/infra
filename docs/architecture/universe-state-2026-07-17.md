...
| hatchet-engine                | gxy-management / artemis | `hatchet-engine:v0.88.6@sha256:5f4e17be…`               | ✅ digest live since the 2026-08-23 roll (hatchet rev 2, chart 0.2.0); the `d532ecb9` pin took effect then |
