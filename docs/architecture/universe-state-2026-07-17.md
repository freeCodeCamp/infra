...
| hatchet-engine                | gxy-management / artemis | `hatchet-engine:v0.88.6` (no digest in running pod)     | ⚠️ values pin digest (`d532ecb9` 2026-07-06) but pod predates pin (started 2026-06-06) — takes effect next roll. **Closed 2026-08-23**: engine rolled (hatchet rev 2, chart 0.2.0), `sha256:5f4e17be…` now live in the pod |
