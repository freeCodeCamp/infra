...
**Paired with:** [`07-woodpecker-oauth-app.md`](07-woodpecker-oauth-app.md) — OAuth provisioning.
**Prerequisites closed:** OAuth app + chart deployed — this runbook only exposes the service.
...
2. **Access policy.** Misconfiguring the policy (wrong group, wrong
   ...
   binding and the group/email allow-list against the OAuth app runbook.
...
- OAuth app provisioned + chart deployed; server + agent Ready (see
  [`07-woodpecker-oauth-app.md`](07-woodpecker-oauth-app.md)).
